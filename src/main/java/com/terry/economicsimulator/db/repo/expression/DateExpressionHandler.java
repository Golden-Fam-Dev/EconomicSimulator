...
import com.terry.economicsimulator.models.input.expression.DateExpression;
...
public final class DateExpressionHandler {
  private DateExpressionHandler() {
  }

  public static <R extends Record> Condition handleExpression(DateExpression expression, Condition condition, TableField<R, LocalDate> tableField) {
    if (expression == null) {
      return condition;
    }
