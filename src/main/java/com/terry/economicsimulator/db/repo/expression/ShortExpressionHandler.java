...
import com.terry.economicsimulator.models.input.expression.ShortExpression;
import org.jooq.Condition;
import org.jooq.Record;
import org.jooq.TableField;

public final class ShortExpressionHandler {
  private ShortExpressionHandler() {
  }

  public static <R extends Record> Condition handleExpression(ShortExpression expression, Condition condition, TableField<R, Short> tableField) {
    if (expression == null) {
      return condition;
    }
